...
export default function PokeSearch() {
  ...
  return (
    <div className="appBody">
      ...
      {searched === true ? (
      <div className="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-2 row-cols-xl-2 w-100 m-0">
        ...
        <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-8">
          <div className="OffDef-cards row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-1 row-cols-xl-1 m-auto">
